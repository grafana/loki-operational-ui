...
import { Card, CardHeader, CardContent, CardTitle } from "gcomponents/ui/card";
import { ErrorBoundary } from "gcomponents/shared/errors/error-boundary";
import { useState } from "react";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "gcomponents/ui/tabs";
import { CodeBlock } from "gcomponents/ui/code-block";
import { format } from "date-fns";
import { useNodeDetails } from "ghooks/use-node-details";
import { useNodeMetrics } from "ghooks/use-node-metrics";
import { ServiceStateDistribution } from "gcomponents/nodes/service-state-distribution";
import { ServiceTable } from "gcomponents/nodes/service-table";
import { StorageTypeIndicator } from "gcomponents/nodes/storage-type-indicator";
import { Label } from "gcomponents/ui/label";
import { LogLevelSelect } from "gcomponents/nodes/log-level-select";
import { Switch } from "gcomponents/ui/switch";
import { VersionInformation } from "gcomponents/nodes/version-information";
import { NodeStatusIndicator } from "gcomponents/nodes/node-status-indicator";
import { PprofControls } from "gcomponents/nodes/pprof-controls";
import { CopyButton } from "gcomponents/common/copy-button";
