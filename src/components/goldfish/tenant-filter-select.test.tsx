...
describe('TenantFilterSelect - Radix UI Select component tests', () => {
  ...
  describe('rendering', () => {
    it('renders with no selection (All Tenants)', () => {
      render(<TenantFilterSelect value={undefined} onChange={mockOnChange} tenants={mockTenants} />);
    ...
    it('renders with a selected tenant', () => {
      render(<TenantFilterSelect value="tenant-b" onChange={mockOnChange} tenants={mockTenants} />);
    ...
    it('renders with empty tenant list', () => {
      render(<TenantFilterSelect value={undefined} onChange={mockOnChange} tenants={[]} />);
  ...
  describe('selection', () => {
    ...
    it('selects All Tenants (undefined) when clicked', async () => {
      render(<TenantFilterSelect value="tenant-a" onChange={mockOnChange} tenants={mockTenants} />);
    ...
    it('maintains selection after closing and reopening', async () => {
      render(<TenantFilterSelect value="tenant-c" onChange={mockOnChange} tenants={mockTenants} />);
  ...
  describe('sorting', () => {
    it('sorts tenant options alphabetically', () => {
      ...
      render(<TenantFilterSelect value={undefined} onChange={mockOnChange} tenants={unsortedTenants} />);
  ...
  describe('edge cases', () => {
    it('handles null onChange gracefully', () => {
      expect(() => {
        render(<TenantFilterSelect value={undefined} onChange={null as unknown as () => void} tenants={mockTenants} />);
      }).not.toThrow();
    });
    ...
    it('handles duplicate tenants', () => {
      ...
      render(<TenantFilterSelect value={undefined} onChange={mockOnChange} tenants={duplicateTenants} />);
    ...
    it('handles special characters in tenant names', () => {
      ...
      render(<TenantFilterSelect value="tenant-@#$" onChange={mockOnChange} tenants={specialTenants} />);
    ...
    it('handles very long tenant names', () => {
      ...
      render(<TenantFilterSelect value={longTenant} onChange={mockOnChange} tenants={[longTenant]} />);
