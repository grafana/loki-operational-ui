...
describe('TimeRangeSelector', () => {
  ...
  describe('preset ranges', () => {
    ...
    it('selects last 15 minutes preset', async () => {
      ...
      expect(mockOnChange).toHaveBeenCalledWith(new Date('2024-01-15T11:45:00Z'), new Date('2024-01-15T12:00:00Z'));
    });
    ...
    it('selects last 3 hours preset', async () => {
      ...
      expect(mockOnChange).toHaveBeenCalledWith(new Date('2024-01-15T09:00:00Z'), new Date('2024-01-15T12:00:00Z'));
    });
    ...
    it('selects last 7 days preset', async () => {
      ...
      expect(mockOnChange).toHaveBeenCalledWith(new Date('2024-01-08T12:00:00Z'), new Date('2024-01-15T12:00:00Z'));
    });
  });
