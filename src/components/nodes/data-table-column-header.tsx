    ...
    <div className="flex items-center space-x-2">
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="ghost" size="sm" className="-ml-3 h-8 hover:bg-muted/50 data-[state=open]:bg-muted/50">
        ...
        <DropdownMenuContent align="start">
          <DropdownMenuItem
            ...
            className={cn('cursor-pointer', isCurrentSort && sortDirection === 'asc' && 'bg-accent')}
          >
          ...
          <DropdownMenuItem
            ...
            className={cn('cursor-pointer', isCurrentSort && sortDirection === 'desc' && 'bg-accent')}
          >
